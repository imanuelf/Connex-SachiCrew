...
('app_title', 'connex - Ultimate Project Manager and CRM', 0),
('currency_symbol', '$', 0),
('date_format', 'Y-m-d', 0),
('decimal_separator', '.', 0),
